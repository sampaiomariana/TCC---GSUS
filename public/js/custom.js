...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    ...
    toastr.success("Bem vindo ao GSUS!");
  }
  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Bem vindo ao GSUS!", " Info message");
      } else if (thisId === "toaster-success") {
        toastr.success("Bem vindo ao GSUS!", "Success message");
      } else if (thisId === "toaster-warning") {
        toastr.warning("Bem vindo ao GSUS!", "Warning message");
      } else if (thisId === "toaster-danger") {
        toastr.error("Bem vindo ao GSUS!", "Danger message");
      }
    });
  }
