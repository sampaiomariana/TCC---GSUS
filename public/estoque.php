...
$slq_medicamentos = "SELECT * FROM medicamento";
$query_medicamentos = $mysqli->query($slq_medicamentos) or die($mysqli->error);
$num_medicamentos = $query_medicamentos->num_rows;
?>
  ...
  <body class="navbar-fixed sidebar-fixed" id="body">
                ...
                <div class="col-xl">
                    ...
                    <div class="card card-default">
                      <div class="card-header align-items-center">
                        ...
                        <h2 class="">Estoque de medicamentos</h2>
                        </div>
                      <div class="card-body">
    ...
    <table id="productsTable" class="table table-hover table-product" style="width:100%">
        <tr>
            ...
            <th>ID</th>
            <th>Nome</th>
            <th>Classificação do medicamento</th>
            <th>Informações</th>
            <th>Preço</th>
            <th>Quantidade</th>
        ...
        <?php 
          if($num_medicamentos == 0) { ?>
            <tr>
              <td colspan="6">Nenhum medicamento foi encontrado</td>
            </tr> 
            <?php
        } else {
          while ($medicamentos = $query_medicamentos->fetch_assoc()) {

            ?>
              <tr>
                <td><?php echo $medicamentos['id_medicamento'];?></td>
                <td><?php echo $medicamentos['nome']; ?></td>
                <td><?php echo $medicamentos['classificacao_medicamento']; ?></td>
                <td><?php echo $medicamentos['informacoes']; ?></td>
